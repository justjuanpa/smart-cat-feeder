...
PHONE_TRAIN_DIR = SCRIPT_DIR / "train_phone_sim"
PROFILE_PATH = SCRIPT_DIR / "pet_profiles_phone_sim.npz"

PET_TRAIN_FOLDERS = {
    "spiderman": [PHONE_TRAIN_DIR / "pet1"],
    "milo": [PHONE_TRAIN_DIR / "pet2"],
}
...
def main():
    ...
    print("Building phone-sim pet profiles...")
    ...
    print(f"\nSaved phone-sim profiles to {PROFILE_PATH}")
