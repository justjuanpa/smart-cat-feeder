...
INPUT_DIR = SCRIPT_DIR / "camera_tests"
OUTPUT_DIR = SCRIPT_DIR / "yolo_crop_tests"
...
def main():
    ...
    for folder_name, input_folder in TEST_FOLDERS.items():
