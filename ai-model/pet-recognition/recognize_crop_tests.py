...
CROP_TEST_DIR = SCRIPT_DIR / "crop_tests"
PROFILE_PATH = SCRIPT_DIR / "pet_profiles.npz"

TEST_FOLDERS = {
    "spiderman": CROP_TEST_DIR / "pet1",
    "grogu": CROP_TEST_DIR / "pet2",
    "unknown": CROP_TEST_DIR / "unknown",
}
...
def main():
    ...
    print(f"Testing camera images from {CROP_TEST_DIR}")
    print("\nTesting images...\n")
