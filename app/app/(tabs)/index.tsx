    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.heroCard}>
          <View style={[styles.statusDot, deviceOnline ? styles.statusOnline : styles.statusOffline]} />
          <Text style={styles.heroLabel}>Feeder status</Text>
          <Text style={styles.heroTitle}>{deviceOnline ? 'Online and reporting' : 'Waiting for feeder'}</Text>
          ...
          <View style={styles.metrics}>
            ...
            <Metric label="Bowl" value={formatGrams(deviceStatus?.current_weight_grams ?? null)} />
          </View>
        </View>
        ...
        <View style={styles.quickGrid}>
          ...
          />
          <QuickCard href="/(tabs)/pets" icon="pets" title="Pets" detail={`${pets.length} active profiles`} />
          <QuickCard
            href="/(tabs)/device"
            icon="memory"
            title="Device"
        ...
        {loading ? <Text style={styles.muted}>Refreshing dashboard...</Text> : null}
      </ScrollView>
    </SafeAreaView>
  );
}
...
function QuickCard({
  ...
  return (
    <Pressable onPress={() => router.push(href as never)} style={styles.quickCard}>
